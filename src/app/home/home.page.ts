  ...
  constructor(private router: Router) {
    this.addEvents = [
      ...
      },
      {
        ...
        "upload_date": 12,
        "kategori": "konser",
        "host": "../../assets/img/event-01.jpg"
      },
      {
        "code": "23",
        "name": "Jakarta Festival Clooths",
    ...
    this.events = [this.addEvents[0],this.addEvents[1],this.addEvents[2]];
    this.segmentsKategori = [
      {
        "bg": "../../assets/img/event-01.jpg",
        "name": "konser"
      },
      {
        "bg": "../../assets/img/event-02.jpg",
        "name": "festival"
      },
      {
        "bg": "../../assets/img/event-03.jpg",
        "name": "sosial"
      },
      {
        "bg": "../../assets/img/event-02.jpg",
